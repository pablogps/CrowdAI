...
namespace SharpNeat.Network
{
    ...
    /// 
    /// One significant use of this class is in the decoding of genome classes
    /// into concrete network instances; the decode methods can be written to
    /// operate on INetworkDefinition rather than specific genome types.
    /// </summary>

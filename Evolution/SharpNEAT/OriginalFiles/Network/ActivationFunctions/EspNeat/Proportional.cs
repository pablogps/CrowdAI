...
namespace SharpNeat.Network
{
    ...
    public class Proportional : IActivationFunction
    {
        ...
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new Proportional();
        ...
        /// Calculates the output value for the specified input value and
        /// optional activation function auxiliary arguments.
        /// This single precision overload of Calculate() will be used in
        /// neural network code that has been specifically written to use

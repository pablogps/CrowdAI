...
{
    /// <summary>
    /// Step function displaced so activation requires a minimum input (to
    /// avoid activating regulatory neurons with residual activity).
    /// </summary>
    public class StepFunctionOffset : IActivationFunction
    {
        /// <summary>
        /// Default instance provided as a public static field.
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new StepFunctionOffset();

...
{
    /// <summary>
    /// An approximation of the SteepenedSigmoid activation function. Faster to
    /// calculate but anecdotal evidence suggests using this function gives
    /// poorer results than SteepenedSigmoid.
    /// 
    /// The increase in speed may also be in question with more recent hardware
    /// developments. E.g. with faster implementations of an exp function and
    /// underlying CPU execution of the code.
    /// </summary>

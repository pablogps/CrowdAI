    ...
    public static class NetworkXmlIO
    {
        ...
        public static NodeType GetNodeType(string type)
        {
            switch(type)
            {
                ...
                // ESP types:
                case "local in":
                    return NodeType.Local_Input;
                case "local out":
                    return NodeType.Local_Output;
                case "reg":
                    return NodeType.Regulatory;
            }
        ...
        public static IActivationFunction GetActivationFunction(string name)
        {
            switch(name)
            {
                ...
                case "Proportional":
                    return Proportional.__DefaultInstance;
                case "Sine":
                ...
                case "InverseAbsoluteSteepSigmoid":
                    return InverseAbsoluteSteepSigmoid.__DefaultInstance;
                case "InverseAbsoluteSigmoidForOut":
                    return InverseAbsoluteSigmoidForOut.__DefaultInstance;
                case "PlainSigmoid":
                ...
                case "StepFunctionOffset":
                    return StepFunctionOffset.__DefaultInstance;
                case "RbfGaussian":

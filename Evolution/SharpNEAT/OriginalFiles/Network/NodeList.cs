...
namespace SharpNeat.Network
{
    ...
    public class NodeList : List<INetworkNode>, INodeList
    {
        ...
        /// Uses a binary search for fast searching, however this assumes the 
        ...
        /// <summary>
        /// Indicates if the nodes are sorted by ID in ascending order, as 
        /// required by BinarySearch(). For debug purposes only. Don't call this
        /// method in normal circumstances as it is an expensive O(n) operation.
        /// </summary>

...
namespace SharpNeat.Utility
{
    ...
    public class FastRandom
    {
        ...
        //static readonly int seed0 = 406147791;
        ...
        /// <summary>
        /// Always showing the user the seed used in the generator allows to
        /// replicate specific runs (great for debugging).
        /// </summary>
        void DisplaySeed()
        {
            if (!hasSeedBeenDisplayed)
            {
                Console.WriteLine("Using seed: " + seed0 + "\n");
                hasSeedBeenDisplayed = true;
            }
        }
        ...
        {
            // UnityEngine.Debug.Log("FastRandom reinitialize seed " + seed);
            Reinitialise(seed);
        }

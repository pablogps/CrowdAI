...
{
    /// <summary>
    /// An IDistanceMetric represents a metric for measuring the distance 
    /// between two genome positions in an encoding space, and thus the 
    /// compatibility of the two genomes with respect to the probability of creating
    /// fit offspring.
    /// 
    /// What makes a good or ideal compatibility metric is an open question

...
namespace SharpNeat.Core
{
    ...
    public interface IGenome<TGenome>
    {
        ...
        void UpdateParametersInFactory(bool isNormalParameters);
        ...
        /// <summary>
        /// Used during debugging. Allows to get info from a connection.
        /// Column 1 --> ID. 2 --> Source neuron. 3 --> Target neuron.
        /// Weight is double (not uint) so we skip this.
        /// 4 --> calls SortByInnovationId!
        /// </summary>
        // uint GetConnectionInfo(int index, int column);
    }
}

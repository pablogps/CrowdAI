...
namespace SharpNeat.Core
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        /// This is used to let optimizer know when there are updates
        /// in the evolution algorithm.
        /// </summary>
        event EventHandler<Evolution.EvolutionEventsArgs> UpdateEvent;
        ...
        /// convenient to do so, and notifies listeners via an UpdateEvent.
        /// </summary>
        void RequestPause();

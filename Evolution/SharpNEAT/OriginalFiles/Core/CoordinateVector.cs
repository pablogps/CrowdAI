...
{
    /// <summary>
    /// General purpose representation of a point in a multidimensional space. 
    /// A vector of coordinates, each coordinate defining the position within 
    /// a dimension/axis defined by an ID.
    /// </summary>

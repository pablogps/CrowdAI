...
{
    /// <summary>
    /// Represents an update scheme for an IEvolutionAlgorithm. e.g. whether the
    /// algorithm should be updated after some time duration or some number of generations.
    /// </summary>
    public class UpdateScheme
    {
        ...
        /// <summary>
        /// Gets the number of generations between updates; Applies only to the 
        ...
        /// <summary>
        /// Gets the number timespan between updates; Applies only to the 
        /// timespan update scheme.
        /// </summary>

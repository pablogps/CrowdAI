...
namespace SharpNeat.Core
{
    ...
    {   // Specie IDs are unique within a population.
        readonly uint _id;
        int _idx;
        ...
        /// <summary>
        /// Construct a specie with the specified ID, index; and creates an 
        /// empty genome list with a specified capacity.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the index of the specie in its containing list. 
        /// This is a working variable that typically will be the same as the 
        /// specie ID but is not guaranteed to be, e.g. in a distributed NEAT 
        ...
        /// <summary>
        /// Gets or sets the centroid position for all genomes within the specie. 
        /// Note that this may be out of date, it is the responsibility of code 
        /// external to this class to recalculate and set a new centroid if the 
        /// set of genomes in the specie has changed and therefore the specieList 
        /// centroid has also changed.
        /// </summary>
        ...
        /// Implemented as a method rather than a property as an indication that 
        /// this method does significant work to calculate the value.
        /// </summary>

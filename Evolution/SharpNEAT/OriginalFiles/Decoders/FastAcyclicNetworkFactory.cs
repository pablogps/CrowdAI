...
namespace SharpNeat.Decoders
{
    ...
    public class FastAcyclicNetworkFactory
    {
        ...
        {
            Debug.Assert(!CyclicNetworkTest.IsNetworkCyclic(networkDef), 
        ...
        //=== Create array of FastConnection(s). 
            ...
            for (int currDepth = 0; currDepth < netDepth; currDepth++)
            {
                ...
                for (; connIdx < fastConnectionArray.Length && 
					   nodeInfoByDepth[fastConnectionArray[connIdx]._srcNeuronIdx]._nodeDepth == currDepth; connIdx++);
            ...
            return new FastAcyclicNetwork(nodeActivationFnArr, nodeAuxArgsArray, fastConnectionArray, layerInfoArr, 
										  outputNeuronIdxArr, nodeCount, networkDef.InputNodeCount, 

...
namespace SharpNeat.Decoders
{
    ...
    {
        // Change all these bool flags for a enum?
        bool _esp;
     ...
     //=== Cyclic network specific activation.
        ...
        /// <summary>
        /// Gets a value indicating whether the network is ESP-type or not.
        /// </summary>
        public bool Esp
        {
            get { return _esp; }
        ...
        /// <summary>
        /// Gets a value indicating whether a fast version of the network 
        /// should be created when decoding.
        /// </summary>
        ...
        /// <summary>
        /// Create an activation scheme with a fixed number of activation 
        /// timesteps (suitable for cyclic networks only).
        /// </summary>
        public static NetworkActivationScheme CreateCyclicFixedTimestepsScheme(
        ...
        /// </summary>
        public static NetworkActivationScheme CreateCyclicFixedTimestepsScheme(
                int timestepsPerActivation, bool fastFlag)
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme._acyclicNetwork = false;
            scheme._timestepsPerActivation = timestepsPerActivation;
        ...
        /// </summary>
        public static NetworkActivationScheme CreateCyclicRelaxingActivationScheme(
                double signalDeltaThreshold, int maxTimesteps)
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme._acyclicNetwork = false;
        ...
        /// </summary>
        public static NetworkActivationScheme CreateCyclicRelaxingActivationScheme(
                double signalDeltaThreshold, int maxTimesteps, bool fastFlag)
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme._acyclicNetwork = false;
            scheme._signalDeltaThreshold = signalDeltaThreshold;

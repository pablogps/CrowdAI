...
namespace Malmo
{
    class MazeControllerWithDiagonals
    {
        IBlackBox brain;
        ...
        public MazeControllerWithDiagonals(IBlackBox givenBrain, ProgramMalmo givenMalmo)
        {
        ...
        void UpdateRangeDetectors()
        {
            ...
            brain.InputSignalArray[5] = 0.0;
            brain.InputSignalArray[6] = 0.0;
            brain.InputSignalArray[7] = 0.0;
            ...
            if (neighbourTiles.Level0.aheadLeft != "air" || neighbourTiles.LevelSub1.aheadLeft == "lava")
            {
                brain.InputSignalArray[4] = 1.0;
            }
            else if (neighbourTiles.Level0.farAheadLeft != "air" || neighbourTiles.LevelSub1.farAheadLeft == "lava")
            {
                brain.InputSignalArray[4] = 0.5;
            }
            if (neighbourTiles.Level0.aheadRight != "air" || neighbourTiles.LevelSub1.aheadRight == "lava")
            {
                brain.InputSignalArray[5] = 1.0;
            }
            else if (neighbourTiles.Level0.farAheadRight != "air" || neighbourTiles.LevelSub1.farAheadRight == "lava")
            {
                brain.InputSignalArray[5] = 0.5;
            }
            if (neighbourTiles.Level0.backLeft != "air" || neighbourTiles.LevelSub1.backLeft == "lava")
            {
                brain.InputSignalArray[6] = 1.0;
            }
            else if (neighbourTiles.Level0.farBackLeft != "air" || neighbourTiles.LevelSub1.farBackLeft == "lava")
            {
                brain.InputSignalArray[6] = 0.5;
            }
            if (neighbourTiles.Level0.backRight != "air" || neighbourTiles.LevelSub1.backRight == "lava")
            {
                brain.InputSignalArray[7] = 1.0;
            }
            else if (neighbourTiles.Level0.farBackRight != "air" || neighbourTiles.LevelSub1.farBackRight == "lava")
            {
                brain.InputSignalArray[7] = 0.5;
            }
        }
        ...
        void UpdateRadarInputs()
        {
            ...
            brain.InputSignalArray[8] = xDist;
            brain.InputSignalArray[9] = zDist;
